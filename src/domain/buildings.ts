...
export const BUILDINGS: BuildingDef[] = [
  { id: 'camp_shelter', threshold: 0, tag: 'plain' },
  { id: 'well', threshold: 10, tag: 'plain' },
  { id: 'granary', threshold: 30, tag: 'plain' },
  { id: 'smithy', threshold: 40, tag: 'plain' },
  { id: 'shrine', threshold: 50, tag: 'plain' },
  { id: 'mill', threshold: 60, tag: 'tech' },
  ...
  { id: 'inn', threshold: 500, tag: 'plain' },
  { id: 'wood_walls', threshold: 600, tag: 'plain' },
